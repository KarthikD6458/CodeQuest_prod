// src/components/sessions/DeleteSessionModal.jsx
      ...
      >
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-center mb-4">
            Are you sure you want to delete the session for <span className="font-medium text-gray-900 dark:text-white">{session.candidate_name}</span>? This action cannot be undone.
          </p>
          
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-3 mb-6">
            <p className="text-sm text-yellow-800 dark:text-yellow-300">
              All associated data, including search history and notes, will be permanently deleted.
            </p>
          </div>
